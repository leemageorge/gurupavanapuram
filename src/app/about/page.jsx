...
const About = () => {
  ...
  return (
    <section className="w-full bg-amber-100">
        ...
        <div>
          <div className="flex flex-col justify-center items-center gap-10 md:flex-row">
            ...
            <div className="w-full md:w-1/2 ">
              <p className="text-gray-700 text-lg leading-relaxed text-left px-4">
                ...
                performing poojas, homams, and santhi rituals at the Chuzhal
          ...
          <div className="flex flex-col-reverse items-center gap-10 md:flex-row mt-12 ">
            <div className="w-full md:w-1/2 ">
              <p className="text-gray-700 text-lg leading-relaxed text-left mt-6  ">
      ...
      <div className="container mx-auto px-6 md:px-10  max-w-4xl min-h-[70vh]">
        <iframe
