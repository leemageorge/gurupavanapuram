        ...
        <div className='border-2 border-amber-900 rounded-bl-4xl rounded-tr-4xl '>
          <form className='py-6  '>
           <div className='space-y-2'>
             <input type='text' placeholder="Full Name" className='border-1 w-3/4 rounded-md border-amber-900 px-4 py-1 text-red-700 outline-none'/>
            <input type='text' placeholder="Phone Number" className='border-1 w-3/4 rounded-md border-amber-900 px-4 py-1 text-red-700 outline-none'/>
            <input type='text' placeholder="Nakshatra" className='border-1 w-3/4 rounded-md border-amber-900 px-4 py-1 text-red-700 outline-none'/>
            <input type='text' placeholder="Subject" className='border-1 w-3/4 rounded-md border-amber-900 px-4 py-1 text-red-700 outline-none'/>
            <input type='text' placeholder="Nakshatra" className='border-1 w-3/4 rounded-md border-amber-900 px-4 py-1 text-red-700 outline-none'/>
            <textarea type='text'  placeholder="Message" className='border-1 w-3/4 rounded-md border-amber-900 px-4 py-1 text-red-700 outline-none resize-none'/>
           </div>
           <div className='bg-amber-900 p-1 w-fit mx-auto rounded-bl-xl rounded-tr-xl'>
             <button className=' text-amber-100 px-4 py-2 rounded-bl-xl rounded-tr-xl font-bold shadow-xl border-1 border-amber-100'>Send Message</button>
           </div>
