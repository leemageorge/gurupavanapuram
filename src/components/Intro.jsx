...
const Intro = () => {
  return (
      ...
      <div className='container max-w-5xl py-14 px-10  mx-auto '>
        <div className='grid grid-cols-1 lg:grid-cols-2 place-items-center gap-y-16 lg:gap-y-8  gap-x-10 px-6 md:px-8 py-1 md:py-12'>
