...
const Jathakam = () => {
  return (
    ...
    <div className='container mx-auto px-6 md:px-10  max-w-5xl overflow-hidden'>
         <h2 className='text-2xl md:text-4xl font-bold  text-red-700 text-center mb-6'>ജാതകം</h2>
    ...
    <div className=' flex flex-col space-y-2 p-8'>
        ...
        <p className='text-lg text-gray-600 text-left'>ജാതകം എഴുതുന്നത് ഭാവി അറിയാനായി മാത്രം അല്ല.
